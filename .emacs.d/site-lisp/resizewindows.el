...
middle"
  (let* ((win-edges (window-edges))
    ...
    (cond
     ...
     ((eq (+ fr-width 6) this-window-x-max) "right")
     (t "mid"))))
...
(global-set-key [S-s-left] 'win-resize-minimize-horiz)
(global-set-key [S-s-right] 'win-resize-enlarge-horiz)
(global-set-key [S-s-up] 'win-resize-enlarge-horiz)
(global-set-key [S-s-down] 'win-resize-minimize-horiz)
(global-set-key [S-s-left] 'win-resize-enlarge-vert)
(global-set-key [S-s-right] 'win-resize-minimize-vert)

(provide 'resizewindows)
